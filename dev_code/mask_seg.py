...
if __name__ == '__main__':
    ...
    for subfolder_id, subfolder_path in enumerate(subfolders):
        ...
        source_file = subfolder_path + '/' + folder_name + '_mask.png'
        ...
        print("parent_folder_name:'{}' \n".format(parent_folder_name))

        
        mkpath = target_path + '/' + parent_folder_name + '_mask'
        mkdir(mkpath)
        result_path = mkpath + '/'
        
        target_file = result_path + folder_name + '_mask.png'
    ...
    for image_id, image in enumerate(imgList):
        ...
        batch_cmd = "split-image " + image + " 4 5 --output-dir " + save_path
