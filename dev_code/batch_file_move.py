...
USAGE:
    ...
    python3 batch_file_move.py -p /input/ -r /output/
...
if __name__ == '__main__':
    ...
    for subfolder_id, subfolder_path in enumerate(subfolders):
        ...
        '''
        # copy all the files from sub folder
        ##################################################3
        folder_name = os.path.basename(subfolder_path)
        
        subfolder_path = os.path.join(subfolder_path, '')
        
        folder_name_short = folder_name.replace("WMG042125_Tray ", "Tray_")
        
        folder_name_short = folder_name_short.replace(".", "_")
        
        source_file = subfolder_path + "/vis/0_0_0.png"
        
        target_file = target_path + folder_name_short + ".png"
        ...
        source_file = subfolder_path + '/' + folder_name + '_img_overlay.png'
        
        
        target_file = target_path + folder_name + '_img_overlay.png'
        ...
        # python3 smart_release_argelia.py -p ~/example/argelia_data/test/ -ai 1
        
        batch_cmd = "python3 smart_release_argelia.py -p " + source_file_path + " -ai 1" 
